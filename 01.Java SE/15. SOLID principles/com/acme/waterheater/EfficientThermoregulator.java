...
public class EfficientThermoregulator implements VentoThermoregulator, Runnable {
	...
	public EfficientThermoregulator(VentoThermometer vThermo, VentoHeater vHeater) {
